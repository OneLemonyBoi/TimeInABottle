...
import com.onelemonyboi.timeinabottle.entities.EntityTimeAccelerator;
...
public class ItemTimeInABottle extends ItemBase implements IForgeRegistryEntry<ItemTimeInABottle> {
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected)
	{
		if (!worldIn.isRemote)
		{
			...
			if (secondWorth == 0 || worldIn.getTotalWorldTime() % secondWorth == 0)
			{
				...
				if (timeData.getInteger("storedTime") < 514200700)
				{
